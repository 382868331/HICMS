...
function AdminDesktop() {
  ...
  const tabItems = [
    ...
    { key: 'book', label: '预约会议管理', children: <BookManagement /> },
    { key: 'room', label: '会议室管理', children: <RoomManagement /> },
    { key: 'member', label: '工作人员管理', children: <MemberManagement /> },
    { key: 'user', label: '用户管理', children: <UserManagement /> },
    { key: 'online', label: '在线用户', children: <OnlineUserManagement /> },
    { key: 'llm', label: '大模型管理', children: <LlmManagement /> },
    { key: 'rag', label: '知识库管理', children: <RagManagement /> },
