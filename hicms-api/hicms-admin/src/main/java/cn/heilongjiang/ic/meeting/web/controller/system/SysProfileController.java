...
import cn.heilongjiang.ic.meeting.common.utils.file.FileUploadUtils;
import cn.heilongjiang.ic.meeting.common.utils.file.FileUtils;
import cn.heilongjiang.ic.meeting.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(HicmsConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(HicmsConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
