...
import cn.heilongjiang.ic.meeting.system.domain.SysNotice;
import cn.heilongjiang.ic.meeting.system.service.ISysNoticeReadService;
import cn.heilongjiang.ic.meeting.system.service.ISysNoticeService;
...
public class SysNoticeController extends BaseController
{
    ...
    /**
     * 首页顶部公告列表（返回全部正常公告，带当前用户已读标记，最?条）
     */
    @GetMapping("/listTop")
    @ResponseBody
