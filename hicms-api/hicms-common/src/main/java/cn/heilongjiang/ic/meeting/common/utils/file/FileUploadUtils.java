package cn.heilongjiang.ic.meeting.common.utils.file;
...
import cn.heilongjiang.ic.meeting.common.exception.file.FileNameLengthLimitExceededException;
import cn.heilongjiang.ic.meeting.common.exception.file.FileSizeLimitExceededException;
import cn.heilongjiang.ic.meeting.common.exception.file.InvalidExtensionException;
import cn.heilongjiang.ic.meeting.common.utils.DateUtils;
import cn.heilongjiang.ic.meeting.common.utils.StringUtils;
import cn.heilongjiang.ic.meeting.common.utils.uuid.IdUtils;
import cn.heilongjiang.ic.meeting.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = HicmsConfig.getProfile();
    ...
    {
        int dirLastIndex = HicmsConfig.getProfile().length() + 1;
